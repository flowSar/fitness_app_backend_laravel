...
Route::middleware('auth:sanctum')->get('/exercises/{exercise}', [ExerciseController::class, 'show'])->name('exercise.show');
Route::get('/exercises', [ExerciseController::class, 'index'])->name('api.exercises');
...
Route::middleware('auth:sanctum')->post('/user/plans', [UserPlanController::class, 'store'])->name('api.user.plans.store');
...
Route::middleware('auth:sanctum')->get('/plans/{plan}/session/exercises', [ExerciseController::class, 'index'])->name('plans.session.exercises');
